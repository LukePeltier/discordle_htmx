...
func (mc *MessageCreate) SetDateSent(s string) *MessageCreate {
	mc.mutation.SetDateSent(s)
	return mc
}

// SetDiscordID sets the "discord_id" field.
func (mc *MessageCreate) SetDiscordID(s string) *MessageCreate {
...
func (mc *MessageCreate) SetSender(d *DiscordMember) *MessageCreate {
	return mc.SetSenderID(d.ID)
}
...
func (mc *MessageCreate) check() error {
	...
	if _, ok := mc.mutation.DateSent(); !ok {
		return &ValidationError{Name: "date_sent", err: errors.New(`ent: missing required field "Message.date_sent"`)}
	}
	if v, ok := mc.mutation.DateSent(); ok {
	...
	if _, ok := mc.mutation.DiscordID(); !ok {
		return &ValidationError{Name: "discord_id", err: errors.New(`ent: missing required field "Message.discord_id"`)}
	}
	return nil
}
...
func (mc *MessageCreate) createSpec() (*Message, *sqlgraph.CreateSpec) {
	...
	if nodes := mc.mutation.SenderIDs(); len(nodes) > 0 {
		...
		_node.discord_member_messages = &nodes[0]
